...
class ModCabang : AppCompatActivity() {
    ...
    private lateinit var tvStatusCabang : TextInputLayout
    private lateinit var spStatusCabang : AutoCompleteTextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etNamaCabang = findViewById(R.id.tietNamaKategori)
        tvStatusCabang = findViewById(R.id.tilModCabangStatus)
        spStatusCabang = findViewById(R.id.spModCabangStatus)
